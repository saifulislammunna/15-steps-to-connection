...
9. Add DB_USER and DB_PASS in  URI string
10. check URI string by console.log
11. create asyn function run and call it by using run().catch(console.dir)
